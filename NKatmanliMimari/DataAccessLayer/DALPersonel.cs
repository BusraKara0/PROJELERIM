...
namespace DataAccessLayer
{
	public class DALPersonel
	{
		public static List<EntityPersonel> PersonelListesi()
		{
			...
			SqlCommand komut1 = new SqlCommand("Select * From TBLBILGII", Baglanti.bgl);
		...
		{
			SqlCommand komut2 = new SqlCommand("insert into TBLBILGII (AD,SOYAD,GOREV,SEHIR,MAAS) VALUES (@P1,@P2,@P3,@P4,@P5)", Baglanti.bgl);
		...
		{
			SqlCommand komut3 = new SqlCommand("Delete from TBLBILGII where ID=@P1", Baglanti.bgl);
		...
		{
			SqlCommand komut4 = new SqlCommand("Update TBLBILGII set AD=@P1,SOYAD=@P2,MAAS=@P3,SEHIR=@P4,GOREV=@P5 where ID=@P6", Baglanti.bgl);
